function [save_T_stat, C_cookd, C_ZRE] = fn_CPM_run_unc(Tout, y_mea, pathnm_csv, pathnm_pics, Case_str, date_fr, date_to)
...
% for m=1:3
    ...
    switch CPM_type
        ...
        case '2p_h'
            ...
            lb=[-inf       Y_min]; % 기울기는 음수 또는 양수 % https://www.sciencedirect.com/science/article/pii/S0378778814009645
            ub=[inf     Y_max];
            nonlcon=[];
        ...
        case '2p_c'
            ...
            lb=[Y_min   -inf]; % 기울기는 음수 또는 양수 % https://www.sciencedirect.com/science/article/pii/S0378778814009645
            ub=[Y_max   inf];
            nonlcon=[];
        ...
        case '5p'
            ...
            Aeq=[];
            beq=[];
            lb=[Y_min   -inf  -inf   To_lb    To_lb]; % To_lb = 10
